...
**Prosperismo is not an emulator of a console. It is a reimplementation of an operating system.**
...
Nothing else — no console, no firmware on the target machine, no devkit. Prosperismo supplies
