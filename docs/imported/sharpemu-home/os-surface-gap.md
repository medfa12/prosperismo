...
The earlier `exp/shell-boot` snapshot recorded 690 HLE exports, 10 classified as
stubs. The regenerated table above supersedes those counts while preserving the
same interpretation.
