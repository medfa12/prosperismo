...
SharpEmu already has the machinery this depends on: `DispatchIl2CppApiLookupSymbol`
...
exactly the NID SharpEmu special-cases as `DispatchIl2CppApiLookupSymbol`
