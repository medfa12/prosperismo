...
/// all 589 cleartext firmware modules found 2628 in-errno-range immediates,
...
public enum OrbisGen2Result : int
{
    ...
    /// The correct value is confirmed directly in firmware: sceKernelWaitEqueue
    ...
    /// occurs nowhere in the 4.03 firmware, so it can never be mistaken for a
    /// code the console produces. That is the point — it marks a SharpEmu gap
    ...
    /// the 4.03 firmware, while EFAULT's 0x8002000E appears 105 times. This is
