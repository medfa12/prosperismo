...
/// </list>
///
/// <para>INERT is a description of behaviour, never a verdict. Real firmware
...
/// <list type="bullet">
///   <item><c>SHARPEMU_HLE_EFFECT_CENSUS=1</c> — enable. When unset, exports keep
///   their original delegate and nothing here is installed at all.</item>
///   <item><c>SHARPEMU_HLE_EFFECT_CENSUS_REPORT=&lt;path&gt;</c> — write the report
///   here instead of stderr.</item>
///   <item><c>SHARPEMU_HLE_EFFECT_CENSUS_INTERVAL=&lt;seconds&gt;</c> — also report
///   periodically, so a boot that is killed still leaves one.</item>
///   <item><c>SHARPEMU_HLE_EFFECT_CENSUS_TRIGGER=&lt;path&gt;</c> — report whenever
///   that file appears, then delete it. A boot can be asked for a census on
///   demand with <c>touch</c>.</item>
///   <item><c>SHARPEMU_HLE_EFFECT_CENSUS_TOP=&lt;n&gt;</c> — how many ranked rows to
///   print (default 40, <c>0</c> for all).</item>
///   <item><c>SHARPEMU_HLE_VERIFIED_NOOPS=&lt;path&gt;</c> — extra firmware-verified
///   no-ops to move out of the ranking; see <see cref="HleVerifiedNoOps"/>.</item>
/// </list>
/// </summary>
public static class HleEffectCensus
{
    private const string EnableVariable = "SHARPEMU_HLE_EFFECT_CENSUS";
    private const string ReportPathVariable = "SHARPEMU_HLE_EFFECT_CENSUS_REPORT";
    private const string IntervalVariable = "SHARPEMU_HLE_EFFECT_CENSUS_INTERVAL";
    private const string TriggerVariable = "SHARPEMU_HLE_EFFECT_CENSUS_TRIGGER";
    private const string LimitVariable = "SHARPEMU_HLE_EFFECT_CENSUS_TOP";
    ...
    public static string RenderReport(string reason, int limit)
    {
        ...
        // correct, firmware-matched exports at the head of the list and send the reader
