...
/// <summary>
/// An export the firmware itself implements as nothing, and the evidence for
...
/// <summary>
/// The set of NIDs whose real firmware implementation does nothing, so the
...
/// firmware. Boots can add more without a rebuild through
/// <c>SHARPEMU_HLE_VERIFIED_NOOPS=&lt;path&gt;</c>, a text file of
...
{
    private const string FileVariable = "SHARPEMU_HLE_VERIFIED_NOOPS";
    ...
    /// <summary>
    /// Marks a NID as a firmware-verified no-op. Throws when the evidence is
