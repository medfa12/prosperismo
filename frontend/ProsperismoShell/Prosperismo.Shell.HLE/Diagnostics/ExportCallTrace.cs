...
/// </para>
/// Enable with <c>SHARPEMU_LOG_EXPORT_CALLS=1</c>. Destination defaults to
/// <c>export-calls.log</c> (<c>SHARPEMU_LOG_EXPORT_CALLS_PATH</c>); the ring holds the
/// last <c>SHARPEMU_LOG_EXPORT_CALLS_RING</c> records (default 65536) and is rewritten
/// every <c>SHARPEMU_LOG_EXPORT_CALLS_FLUSH_MS</c> milliseconds (default 2000).
/// Restrict volume to one library with <c>SHARPEMU_LOG_EXPORT_CALLS_LIB</c>.
/// </remarks>
public static class ExportCallTrace
{
    public const string EnableVariable = "SHARPEMU_LOG_EXPORT_CALLS";
    public const string PathVariable = "SHARPEMU_LOG_EXPORT_CALLS_PATH";
    public const string LibraryVariable = "SHARPEMU_LOG_EXPORT_CALLS_LIB";
    public const string RingVariable = "SHARPEMU_LOG_EXPORT_CALLS_RING";
    public const string FlushVariable = "SHARPEMU_LOG_EXPORT_CALLS_FLUSH_MS";
