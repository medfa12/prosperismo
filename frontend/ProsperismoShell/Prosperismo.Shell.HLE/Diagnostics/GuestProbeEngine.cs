...
/// <list type="bullet">
///   <item><c>SHARPEMU_PROBE_SPEC=&lt;path&gt;</c> — JSON spec file.</item>
///   <item><c>SHARPEMU_PROBE_SPEC_JSON=&lt;json&gt;</c> — inline spec, for one-off runs.</item>
/// </list>
/// </summary>
public static class GuestProbeEngine
{
    private const string SpecPathVariable = "SHARPEMU_PROBE_SPEC";
    private const string SpecInlineVariable = "SHARPEMU_PROBE_SPEC_JSON";
