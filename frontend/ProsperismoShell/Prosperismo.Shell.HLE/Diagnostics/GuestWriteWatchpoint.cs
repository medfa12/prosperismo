...
/// </para>
/// Enable with <c>SHARPEMU_WATCH_WRITE=&lt;hex guest address&gt;</c>, optionally delayed by
/// <c>SHARPEMU_WATCH_WRITE_DELAY_MS</c> (default 5000) so the arming happens after the
/// guest's threads exist.
/// </remarks>
public static class GuestWriteWatchpoint
{
    public const string AddressVariable = "SHARPEMU_WATCH_WRITE";
    public const string DelayVariable = "SHARPEMU_WATCH_WRITE_DELAY_MS";
