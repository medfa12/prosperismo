...
/// </para>
/// Enable with <c>SHARPEMU_SAMPLE_STALLED_THREADS=1</c>; a thread counts as stalled after
/// <c>SHARPEMU_SAMPLE_STALLED_MS</c> milliseconds of silence (default 20000).
/// </remarks>
public static class StalledThreadSampler
{
    public const string EnableVariable = "SHARPEMU_SAMPLE_STALLED_THREADS";
    public const string ThresholdVariable = "SHARPEMU_SAMPLE_STALLED_MS";
