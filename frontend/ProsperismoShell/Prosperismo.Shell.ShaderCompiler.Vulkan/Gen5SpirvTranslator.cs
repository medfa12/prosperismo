...
/// (src/SharpEmu.Libs/VideoOut/VulkanVideoPresenter.cs:4153 builds
...
public static partial class Gen5SpirvTranslator
{
    ...
    /// </summary>
    /// <remarks>
    /// EXTRACTED. Every NGG shader in the decrypted 4.03 firmware exports it
    ...
    private sealed partial class CompilationContext
    {
        ...
        // all 120 shipped NGG objects in the 4.03 firmware agree on its whole
        ...
        private static readonly bool _refuseDroppedPositionExports =
            Environment.GetEnvironmentVariable(
                "SHARPEMU_SPIRV_STRICT_POSITION_EXPORTS") == "1";
        ...
        private void DeclareStageInterface()
        {
            ...
            else if (_stage == Gen5SpirvStage.Pixel)
            {
                ...
                foreach (var attribute in attributes)
                {
                    ...
                    // parameter directly. Sony also uses it to transport raw
        ...
        // NOT firmware-EXTRACTED - which is exactly why nothing below guesses:
        ...
        /// SHARPEMU_SPIRV_ALLOW_DROPPED_POSITION_EXPORTS, and even then it is
            ...
            if (!TryPlanPositionOutputs(exportedTargets, out var slots, out var refusal))
            {
                ...
                if (_vertexPositionOutputControl is null && !_refuseDroppedPositionExports)
                {
                    ReportDiagnosticOnce(
                        ...
                        "SHARPEMU_SPIRV_STRICT_POSITION_EXPORTS=1 to fail the draw instead.");
                    return;
                }
            ...
            uint? instructionFormat)
        {
            ...
            // the descriptor here collapsed the firmware billboard's float2
            ...
            if (_stage == Gen5SpirvStage.Pixel)
            {
                        ...
                        out var debugPackVgprBase))
                {
                    ...
                    var debugScale = float.TryParse(
                        Environment.GetEnvironmentVariable(
                            "SHARPEMU_FORCE_PIXEL_EXPORT_PACK_VGPR_SCALE"),
        ...
        /// <c>s_sendmsg GS_EMIT</c>. Sony's own compositor shaders show the
        ...
        /// NGG program in PS5 firmware 4.03 does - a disassembly census of all
        ...
        /// SharpEmu.Libs/Agc/NggPrimitiveShader.cs for the full scan). It is
        ...
        /// SHARPEMU_SPIRV_ALLOW_DROPPED_POSITION_EXPORTS opt-out, which already
        /// announced the drop.
        /// </summary>
