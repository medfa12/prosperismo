...
// firmware-derived. The host render pass uses the exact recovered additive
...
public static class Ps5ParticleDrawProbe
{
    ...
    public static int Run(string[] args)
    {
        ...
        if (args.Length is < 4 or > 5)
        {
            Console.Error.WriteLine(
                "usage: SharpEmu.Tools.Ps5ParticleDrawProbe " +
        ...
        var geometryPath = Environment.GetEnvironmentVariable("SHARPEMU_PS5_GEOMETRY_DEBUG");
        ...
        var baseRgbaPath = Environment.GetEnvironmentVariable("SHARPEMU_PS5_BASE_RGBA");
        ...
        Console.WriteLine(
            ...
            $"({Ps5NativeParticleRenderState.UiRenderTargetHostFormat}); 0x11 is Dxt3 scratch, not the target");

        var allowClearFrame = string.Equals(
            Environment.GetEnvironmentVariable("SHARPEMU_PS5_ALLOW_CLEAR_FRAME"),
            "1",
    ...
    private static int RunRipple(string[] args)
    {
        ...
        {
            Console.Error.WriteLine(
                "usage: SharpEmu.Tools.Ps5ParticleDrawProbe --ripple " +
    ...
    private static int RunFocus(string[] args)
    {
        ...
        {
            Console.Error.WriteLine(
                "usage: SharpEmu.Tools.Ps5ParticleDrawProbe --focus " +
        ...
        // Controlled diagnostic resources. The seven texels are Sony's exact
    ...
    private static int RunSequence(string[] args)
    {
        ...
        {
            Console.Error.WriteLine(
                "usage: SharpEmu.Tools.Ps5ParticleDrawProbe --sequence " +
        ...
        if (Environment.GetEnvironmentVariable("SHARPEMU_PS5_PERSISTENT_PROBE") == "1")
        {
            var renderer = new VulkanPs5NativeParticleRenderer();
            renderer.InitializeAsync(resources).GetAwaiter().GetResult();
            try
            {
                var repeat = int.TryParse(
                    Environment.GetEnvironmentVariable("SHARPEMU_PS5_PERSISTENT_PROBE_REPEAT"),
        ...
        return changedPixels > 0 ||
            Environment.GetEnvironmentVariable("SHARPEMU_PS5_ALLOW_CLEAR_FRAME") == "1" ? 0 : 1;
    }
        ...
        bool requireFragmentWave32 = false)
    {
        ...
        {
            var vk = Vk.GetApi();
            var appName = (byte*)SilkMarshal.StringToPtr("SharpEmuPs5ParticleDrawProbe");
            ...
            void RenderAndReadback(int firstDraw, int drawCount, int destinationOffset)
            {
                ...
                // Sony's small-particle NGG prologue treats v5 as the expanded
