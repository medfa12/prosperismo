...
public static class ShellSettingsMetrics
{
    ...
    /// <summary>
    /// Settings exposes no per-widget line multiplier. PUI's recovered UI3
    /// focus renderer supplies a 3 px line and 3 px outside offset, so the host
    /// uses that renderer at unity rather than inventing a thinner variant.
    /// </summary>
    public const double FocusLineScale = 1.0;
