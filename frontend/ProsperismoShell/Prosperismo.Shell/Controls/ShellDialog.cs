...
public sealed class ShellDialog : TemplatedControl
{
    ...
    private readonly List<Border> _buttonVisuals = new();
    ...
    public void MoveFocus(int delta)
    {
        ...
        SetFocusedButtonIndex(Math.Clamp(start + delta, 0, _buttons.Count - 1));
    }
    ...
    /// closed on.
    /// </summary>
    public static async Task<string> ShowAsync(Panel host, ShellDialogRequest request)
    {
