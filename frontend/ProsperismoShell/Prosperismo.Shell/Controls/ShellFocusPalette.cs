...
/// <c>FocusRenderWidget</c> (4.03, the only firmware whose method bodies
/// survived).
///
...
public static class ShellFocusPalette
{
    ...
    public const string PaperWhiteOutputEnvironmentVariable =
        "SHARPEMU_PS5_FOCUS_PAPER_WHITE";
    ...
    /// <summary>
    /// Sony's line-alpha tone curve for the stock UI3 control points
