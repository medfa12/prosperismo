...
/// <summary>
/// One filled shape lifted out of a Sony icon SVG.
///
...
public sealed record Ps5VectorIcon(string Id, Rect ViewBox, IReadOnlyList<Ps5IconShape> Shapes)
{
    ...
    public void Render(DrawingContext context, Rect destination, Color tint)
    {
...
/// <summary>
/// The SVG subset Sony's icon set actually uses, and nothing more.
///
...
/// path mini-language is the SVG one, so the curves are Sony's own control
...
public static class Ps5SvgIconParser
{
    ...
    /// and finally to Sony's 64x64 authoring grid.
    /// </summary>
