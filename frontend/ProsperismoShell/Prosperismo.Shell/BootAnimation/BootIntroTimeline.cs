...
{
    /// <summary>Decoded firmware particle-resource values for this frame.</summary>
...
///
/// The phase boundaries are not in the firmware. They were measured off the 3.00
...
public static class BootIntroTimeline
{
    ...
    public static BootIntroFrame SampleAt(double progress, bool complete = false)
    {
        ...
        // The motes change colour on the firmware's own 146 ms step.
