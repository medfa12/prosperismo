...
/// sets the firmware names, run in normalised screen space. No Avalonia and no
...
/// decoded firmware records and converted to normalised screen coordinates by
...
public sealed class BootIntroField
{
    ...
    /// per second squared. This is not a decoded firmware parameter.
    /// </summary>
