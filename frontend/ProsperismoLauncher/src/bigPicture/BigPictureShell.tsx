...
export function BigPictureShell({games, firmwareShellIcons = {}, settings, onSaveSettings, onAddFolders, onDesktop, onLaunch, errorMessage, onDismissError}: BigPictureShellProps) {
