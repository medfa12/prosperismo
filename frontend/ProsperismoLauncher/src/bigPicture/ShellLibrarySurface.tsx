...
const styles = StyleSheet.create({
  ...
  tileFocus: {position: 'absolute', left: -6, right: -6, top: -6, bottom: -6, borderWidth: 3, borderColor: '#fff'},
  ...
  sortFocus: {position: 'absolute', inset: 3, borderWidth: 3, borderRadius: 16, borderColor: '#fff'},
